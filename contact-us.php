                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Phone :+977 9816578501</p>
                                                <p itemprop="description">Phone :+977 9815524534</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Pepsicola-32, Kathmandu</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">foodganj@gmail.com</p>
                                                <p itemprop="description">orderfoodganj@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
